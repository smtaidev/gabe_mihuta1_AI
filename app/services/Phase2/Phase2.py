        ...
        async def generate_single_day_exercise(day_number: int) -> Dict[str, Any]:
            ...
            try:
                ...
                if is_workout:
                    ...
                    # Different fallbacks based on focus - more advanced than Phase 1
                    if "strength" in focus.lower() or "compound" in focus.lower():
                        fallback_exercise = {
                            "day": day_number,
                            "name": f"Advanced {focus} Circuit",
                            "sets": 4,  # More sets than Phase 1
                            "reps": "6-8 per exercise",  # Lower rep range for more intensity
                            "description": f"Complete a challenging circuit of {focus.lower()} exercises with higher intensity and proper form. Include compound movements and focus on progressive overload.",
                            "rest": "45 seconds between sets",  # Less rest than Phase 1
                            "motivational_quote": "When you feel like quitting, remember why you started. Push past your limits today.",
                            "is_workout_day": True,
                            "video_url": f"https://www.youtube.com/results?search_query=advanced+{focus.replace(' ', '+')}+{request.gear.value}+workout"
                        }
                        ...
                        fallback_exercise = {
                            ...
                            "description": "Perform high-intensity intervals with minimal rest. Choose challenging variations of standard exercises to increase heart rate and metabolic demand.",
                            "rest": "45 seconds between rounds",  # Less rest than Phase 1
                            "motivational_quote": "Your body can stand almost anything. It's your mind that you have to convince.",
                            "is_workout_day": True,
                            "video_url": f"https://www.youtube.com/results?search_query=advanced+interval+training+{request.gear.value}"
                        }
                    else:
                        fallback_exercise = {
                            "day": day_number,
                            ...
                            "description": "Choose 5-6 advanced exercises and perform them in circuit style with complex movements and challenging progressions.",
                            "rest": "30 seconds between exercises",
                            "motivational_quote": "Excellence isn't a skill, it's an attitude. Train with purpose.",
                            "is_workout_day": True,
                            "video_url": f"https://www.youtube.com/results?search_query=advanced+circuit+training+{request.gear.value}"
                        }
                    ...
                    week_number = (day_number - 1) // 7 + 1
                    rest_quotes = [
                        "Rest is not a luxury, it's a necessity. Your muscles grow during recovery, not during training.",
                        "Rest days are when champions are made. Your body is rebuilding itself stronger for tomorrow's challenge.",
                        "Recovery is an art form. Master it and watch your performance soar to new heights.",
                        "Rest is productive. Your body is hard at work repairing and strengthening itself for your next intense session.",
                        "Strategic recovery is what separates good athletes from great ones. Honor your rest days."
                    ]
                ...
                if day not in day_numbers:
                    ...
                    if is_workout:
                        placeholder = {
                            ...
                            "motivational_quote": "Challenge yourself or regret not doing so. Today is your opportunity.",
                            "is_workout_day": True
                        }
                    else:
                        placeholder = {
                            "day": day,
                            "motivational_quote": "Recovery isn't passive; it's an active investment in your next performance breakthrough.",
                            "is_workout_day": False
                        }
